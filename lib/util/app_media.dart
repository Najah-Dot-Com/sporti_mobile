...
class AppMedia {
  ...
  static const String done = "$IMAGE_PATH/done.svg";
  // static const String termsAndConditions = "$IMAGE_PATH/terms_condtions.svg";
  static const String termsAndConditions = "$IMAGE_PATH/terms_icons.svg";
  static const String arrowIos = "$IMAGE_PATH/arrow ios.svg";
  // static const String privacyPolicies = "$IMAGE_PATH/privayPolicy.svg";
  static const String privacyPolicies = "$IMAGE_PATH/privacy.svg";
  static const String logout = "$IMAGE_PATH/logout.svg";
  ...
  static const String sportiGreenLogo = "$IMAGE_PATH/sportiGreen.png";
  static const String sportiWhiteLogo = "$IMAGE_PATH/sportiWhite.png";
  ...
  static const String subscriptions = "$IMAGE_PATH/subscriptions_card.svg";

  static const String subscriptionsLarge = "$IMAGE_PATH/subscriptions_larg.svg";

  static const String google = "$IMAGE_PATH/google.svg";
  static const String facebook = "$IMAGE_PATH/fb.svg";
  static const String deleteAccountIcons = "$IMAGE_PATH/delete_account_icon.svg";
  static const String langIcons = "$IMAGE_PATH/lang_icons.svg";
  static const String profileUser = "$IMAGE_PATH/profile_user.svg";
  static const String earningIcons = "$IMAGE_PATH/earning_icons.svg";
  static const String logoutIcons = "$IMAGE_PATH/logout_icons.svg";
  static const String companyLogoNajah = "$IMAGE_PATH/company_logo_najah.png";
