...
Map<String, String> arSU = {
  ...
  AppStrings.txtWriteMessage: "اكتب رسالة...",
  AppStrings.day: "يوم",
  AppStrings.befor: "قبل",
  AppStrings.secondes: "ثانية",
  AppStrings.now: "الان",
  AppStrings.txtDeleteComment :"حذف التعليق",
  AppStrings.ads: "اعلانات",
  AppStrings.txtHintForum :"هذا منتدى للتواصل بين اعضاء التطبيق وللتنافس فيما بينهم",
  AppStrings.txtForum: "المنتدى",
  AppStrings.txtCreateForum: "انشاء منتدى",
  AppStrings.txtNameForum: "اسم المنتدى",
  AppStrings.txtDescForum: "وصف المنتدى ...",
  AppStrings.txtShareApp: "شارك التطبيق",
  ...
  AppStrings.txtCurrency: "الربح",
  AppStrings.subscriptionsHint: "اشتراكك الحالي قد انتهى يرجى تجديد الاشتراك للاستفادة من خدمات التطبيق",
  AppStrings.subscriptionsFreeHint: "ملاحظة بالضغط على زر موافق سوف ينخفض اشتراكك الى اشتراك مجاني",
  AppStrings.txtBackToEnd:  "انقر مرة أخرى للمغادرة",
  AppStrings.txtNext: "التالي",
  AppStrings.txtCallRequest: "يرجى ارسال الطلب ليتم التواصل معك ",
  AppStrings.txtCommunication: "التواصل ",
  AppStrings.txtCheckRevenue: "يرجى التأكد من أنك حصلت على اجمالي",
  AppStrings.txtOrMore: "فأكثر",
  ...
  AppStrings.txtSubscriptions: "الاشتراكات",
  AppStrings.txtSubscriptionsExpire: "هذا الاشتراك سينتهي في : ",
  AppStrings.txtChange: "تغير",
  AppStrings.txtChoseSubscriptions: "اختار اشتراكك",
  ...
  AppStrings.usernameOrEmail: "اسم المستخدم او البريد الالكتروني",
  ...
  AppStrings.iFinishedExcercise: "أتممت التمرين",
  ...
  AppStrings.favoritePackageTxt :"اختر حزمة التمارين المفضلة لديك" ,
  AppStrings.favoritePackageHintTxt :"تحتوي كل حزمة على أفضل تمارين لعضلاتك المستهدفة" ,
  AppStrings.sportiDoTxt :"يمكن لـ Sporti القيام بذلك نيابة عنك" ,
  AppStrings.sportiDoHintTxt :"للحصول على الفوائد الكاملة للتمرين ، عليك تكراره بانتظام ، سيحتفظ Sporti بسجلاتك للمتابعة" ,
  AppStrings.yourCoachTxt :"مدربك معك" ,
  AppStrings.yourCoachHintTxt :"ابدأ بالبحث عن التمرين المفضل لديك في أي وقت وفي أي مكان" ,
  AppStrings.oneMoreTxt : "شيء اخر!",
  AppStrings.oneMoreHintTxt : "مكافآت Sporti بالعملات المعدنية التي يمكن تحويلها إليك إذا أكملت حزمك",
  AppStrings.subscriptionsTxt :"الاشتراكات" ,
  AppStrings.subscriptionsHintTxt :"""مجاني: استخدم التطبيق لمدة شهر واحد فقط
                أساسي: للحصول على الفوائد الكاملة للتطبيق لمدة 3 أشهر
                Ultimate: احصل عليه الآن واستمتع بالتطبيق لمدة عام واحد
                من الملف الشخصي يمكنك اختيار خطة اشتراك""" ,
  AppStrings.website: "الموقع",
  AppStrings.socialMedia: "التواصل الاجتماعي",
  AppStrings.txtCoins: "لديك",
  AppStrings.txtEqualTo: "تساوي ",
};
